module github.com/concrete-eth/concrete-template
...
replace github.com/ethereum/go-ethereum => github.com/concrete-eth/concrete-geth v0.0.0-20230914084838-e82c715e9efd
